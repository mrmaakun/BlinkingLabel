...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mrmaakun/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mrmaakun' => 'mark.serrano@gmail.com' }
  s.source           = { :git => 'https://github.com/mrmaakun/BlinkingLabel.git', :tag => s.version.to_s }
